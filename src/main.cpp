...
unsigned int nTargetSpacing = 1 * 450; // 450 seconds
...
const string strMessageMagic = "TrustPlus Signed Message:\n";
...
static const int64_t nTargetTimespan = 20 * 45;  // 20 blocks
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TrustPlus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "4 July";
        CTransaction txNew;
        txNew.nTime = 1404416230;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x884d316b6bc615d645153e22851f0c980e9303a60cf7ec422a27a0f61c7afffa"));
